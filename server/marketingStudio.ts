...
const studioDestination = "https://ea.fizuxc0der.uk/#systems";
...
export const GEMINI_BOT_THREADS_REVISION: MarketingDraftSeed[] = [
  { contentKey: "threads-gemini-day-01-process", title: "Nak automate MT5 dengan lebih teratur?", language: "en_ms", dayOffset: 1, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Nak explore Gemini Bot EA? This is your chance to study a structured MT5 workflow—rules, setup, demo test, then monitor. Bukan magic button, tapi serious tool for traders yang mahu lebih systematic. Profit is never promised. Check portal: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #DemoFirst #TradingMalaysia" },
  { contentKey: "threads-gemini-day-02-checklist", title: "Jangan terus attach—buat 4 checks dulu", language: "en_ms", dayOffset: 2, assetUrl: "/manus-storage/IMG_2829_afce1590.PNG", assetAlt: "Owner-supplied Gemini Bot EA risk metrics screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Before attach Gemini Bot EA, check symbol, MT5 permission, lot sizing and spread. Simple checks, big difference untuk elak setup mistake. Start smart, test on demo dulu, then decide. Tengok full workflow: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  { contentKey: "threads-gemini-day-03-snapshot-a", title: "Opportunity ada, tapi kena faham process", language: "en_ms", dayOffset: 3, assetUrl: "/manus-storage/IMG_2830_370bd291.PNG", assetAlt: "Owner-supplied Gemini Bot EA profit and loss screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Kalau anda curious dengan Gemini Bot EA, jangan ikut screenshot semata-mata. Study the process, test on demo, dan tengok sama ada workflow ini sesuai dengan risk tolerance anda. Explore sekarang: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  { contentKey: "threads-gemini-day-04-trade-log-a", title: "Screenshot nampak menarik, tapi context lagi penting", language: "en_ms", dayOffset: 4, assetUrl: "/manus-storage/IMG_2828_34f3c4c6.PNG", assetAlt: "Owner-supplied Gemini Bot EA XAUUSD trade detail screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "One trade screenshot can catch attention—but it is not your forecast. Tengok entry, exit, size, timing, drawdown and market condition sebelum buat keputusan. Evidence untuk study, bukan promise. Review portal: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #TradingSystem #RiskFirst" },
  { contentKey: "threads-gemini-day-05-risk", title: "Profit dan loss memang datang satu package", language: "en_ms", dayOffset: 5, assetUrl: "/manus-storage/IMG_2835_7c658f52.PNG", assetAlt: "Owner-supplied Gemini Bot EA risk report screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Dalam trading, winning period dan losing period boleh berlaku bersama. Gemini Bot EA helps execute configured MT5 rules, but volatility, slippage and broker conditions tetap wujud. Faham risk dulu: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #DemoFirst #TradingMalaysia" },
  { contentKey: "threads-gemini-day-06-setup", title: "Kalau nak cuba EA, mula dengan setup yang betul", language: "en_ms", dayOffset: 6, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Interested nak try Gemini Bot EA? Review installation, account binding, settings, demo testing and monitoring. Bila process clear, lebih senang anda decide dengan kepala sendiri. Start your review here: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  { contentKey: "threads-gemini-day-07-snapshot-b", title: "Same EA, different account—jangan compare membuta", language: "en_ms", dayOffset: 7, assetUrl: "/manus-storage/IMG_2840_e120a4fe.PNG", assetAlt: "Owner-supplied Gemini Bot EA second account summary screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Results boleh berbeza ikut balance, settings, broker execution, spread dan market regime. Sebab itu Gemini Bot EA perlu diuji ikut keadaan akaun anda sendiri, bukan copy result orang. Explore dengan lebih bijak: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  { contentKey: "threads-gemini-day-08-activity", title: "Curious? Turn it into a proper demo test", language: "en_ms", dayOffset: 8, assetUrl: "/manus-storage/IMG_2833_571a13e3.PNG", assetAlt: "Owner-supplied Gemini Bot EA XAUUSD activity summary screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Tak perlu rush. Read the guide, attach Gemini Bot EA on demo, monitor behavior and record what you see. Itu cara paling practical untuk tahu workflow ini fit atau tidak dengan cara trading anda: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #TradingSystem #RiskFirst" },
  { contentKey: "threads-gemini-day-09-protected-delivery", title: "Sebelum subscribe, tanya soalan yang betul", language: "en_ms", dayOffset: 9, assetUrl: "/manus-storage/IMG_2837_78a02fa3.PNG", assetAlt: "Owner-supplied Gemini Bot EA trade detail screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "What can I lose? How will I monitor? What if market conditions change? Soalan simple, tapi penting. Gemini Bot EA is for traders who mahu study automation—not chase certainty. Read before deciding: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #DemoFirst #TradingMalaysia" },
  { contentKey: "threads-gemini-day-10-balance", title: "Bot boleh execute, tapi judgement tetap milik anda", language: "en_ms", dayOffset: 10, assetUrl: "/manus-storage/IMG_2834_8b1fe7a4.PNG", assetAlt: "Owner-supplied Gemini Bot EA balance and drawdown screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Gemini Bot EA can follow configured rules on MT5, tetapi anda masih control the setup, monitoring, broker choice and risk. Automation bukan alasan untuk switch off your judgement. Learn more: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  { contentKey: "threads-gemini-day-11-long-short", title: "Jangan tengok result sahaja—tengok drawdown juga", language: "en_ms", dayOffset: 11, assetUrl: "/manus-storage/IMG_2832_9da9f941.PNG", assetAlt: "Owner-supplied Gemini Bot EA long and short activity screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "A better review looks at profit, loss, drawdown, losing streaks, costs and exposure together. Itu yang bantu anda nampak full picture, bukan hanya headline number. Historical evidence is not a forecast: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  { contentKey: "threads-gemini-day-12-metrics", title: "Demo first bukan lambat—itu preparation", language: "en_ms", dayOffset: 12, assetUrl: "/manus-storage/IMG_2829_afce1590.PNG", assetAlt: "Owner-supplied Gemini Bot EA performance metrics screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Before live funds, verify symbol, permission, lot size and expected behavior on demo. Gemini Bot EA deserves a measured test, bukan keputusan terburu-buru sebab nampak one good screenshot: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #TradingSystem #RiskFirst" },
  { contentKey: "threads-gemini-day-13-costs", title: "Bukti yang bagus buat kita tanya soalan lebih baik", language: "en_ms", dayOffset: 13, assetUrl: "/manus-storage/IMG_2831_3625126c.PNG", assetAlt: "Owner-supplied Gemini Bot EA profit and loss chart screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Owner-supplied performance evidence boleh bantu anda investigate timing, sizing and conditions. Tapi jangan anggap result itu akan repeat pada account anda. Study the details here: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #DemoFirst #TradingMalaysia" },
  { contentKey: "threads-gemini-day-14-evidence", title: "Jangan lupa trading costs dalam kira-kira", language: "en_ms", dayOffset: 14, assetUrl: "/manus-storage/IMG_2838_f14608ad.PNG", assetAlt: "Owner-supplied Gemini Bot EA trade history screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Spread, slippage, commission, swap and execution boleh affect your result. Kalau nak evaluate Gemini Bot EA, kira semua costs—not just the attractive gross number. Make an informed decision: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  { contentKey: "threads-gemini-day-15-demo", title: "Automation yang serius perlukan operating plan", language: "en_ms", dayOffset: 15, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Sebelum guna Gemini Bot EA, decide how you will configure, monitor, pause and review it. Software is one part; your discipline and risk limits are still important. Build your plan: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  { contentKey: "threads-gemini-day-16-monthly", title: "Market berubah—good period bukan guarantee", language: "en_ms", dayOffset: 16, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "A strong historical period does not remove future uncertainty. Pasaran boleh berubah, execution boleh berbeza, dan risk tetap ada. Evaluate Gemini Bot EA across your own settings and limits: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #TradingSystem #RiskFirst" },
  { contentKey: "threads-gemini-day-17-questions", title: "Customer journey pun kena clear", language: "en_ms", dayOffset: 17, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Verified access, account binding, installation guide and demo testing—semua ini buat setup lebih kemas. Clear delivery does not remove market risk, but it reduces avoidable confusion. See the Gemini Bot EA flow: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #DemoFirst #TradingMalaysia" },
  { contentKey: "threads-gemini-day-18-not-shortcut", title: "Banyak trade tak semestinya better result", language: "en_ms", dayOffset: 18, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Trade frequency alone is not the full story. Tengok size, drawdown, costs, exposure and market conditions sebelum judge Gemini Bot EA. Data should help you investigate, bukan ikut hype: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  { contentKey: "threads-gemini-day-19-get-started", title: "Ready nak explore Gemini Bot EA?", language: "en_ms", dayOffset: 19, assetUrl: "/manus-storage/IMG_2841_74d86699.PNG", assetAlt: "Owner-supplied Gemini Bot EA second account risk screenshot", destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Kalau anda serius nak study MT5 automation, start with the risk note, read the workflow and test on demo. Jangan kejar janji—buat review yang boleh anda explain dan monitor. Visit the portal: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  { contentKey: "threads-gemini-day-20-review", title: "Kalau tak boleh explain, jangan terus automate", language: "en_ms", dayOffset: 20, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Choose only a workflow yang anda faham, boleh monitor and boleh accept risikonya. Gemini Bot EA is an opportunity to evaluate automation, income is never promised. Review the full details before you decide: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #TradingSystem #RiskFirst" },
];

export const GEMINI_BOT_THREADS_ADDITIONS: MarketingDraftSeed[] = [
  { contentKey: "threads-gemini-day-21-quick-start", title: "Nak start? Jangan skip the checklist", language: "en_ms", dayOffset: 21, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Nak start Gemini Bot EA? Jangan skip the basics—read the guide, check your MT5 environment and run a demo test dulu. If the workflow fits your style, then you can decide with more confidence. Explore now: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #DemoFirst #TradingMalaysia" },
  { contentKey: "threads-gemini-day-22-monitor", title: "Automation tak bermaksud boleh tinggal", language: "en_ms", dayOffset: 22, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Gemini Bot EA boleh follow configured rules, but you still need to monitor spread, exposure, drawdown and execution. Nak automation yang lebih disciplined? Start by understanding what you are running: https://ea.fizuxc0der.uk/ #GeminiBotEA #RiskManagement #MT5 #DemoFirst" },
  { contentKey: "threads-gemini-day-23-fit", title: "Bukan untuk semua account—check dulu", language: "en_ms", dayOffset: 23, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Different balance, broker and settings can produce different behavior. Sebelum decide nak guna Gemini Bot EA, review the workflow against your own risk limits. Jangan copy blindly—test properly: https://ea.fizuxc0der.uk/ #GeminiBotEA #TradingMalaysia #RiskFirst #MT5" },
  { contentKey: "threads-gemini-day-24-system", title: "Kalau serious, treat it like a system", language: "en_ms", dayOffset: 24, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Serious traders know the difference between hype and a process. Gemini Bot EA gives you a structured MT5 workflow to study, configure and monitor. Bukan income guarantee—it's a system you must understand: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #DemoFirst #TradingMalaysia" },
  { contentKey: "threads-gemini-day-25-decision", title: "Last step: decide dengan kepala sendiri", language: "en_ms", dayOffset: 25, destinationUrl: "https://ea.fizuxc0der.uk/", caption: "Dah review the rules, risk note and demo flow? Then decide whether Gemini Bot EA fits your trading plan. No hype, no shortcut—just clear information before you commit: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #RiskManagement #DemoFirst" },
];
...
export const GEMINI_EVENT_PORTAL_URL = "https://ea.fizuxc0der.uk/";
...
export const EVERGREEN_GEMINI_COPY_BANK = [
  ...
  { title: "Jangan terus attach—buat 4 checks dulu", caption: "Before attach Gemini Bot EA, check symbol, MT5 permission, lot sizing and spread. Simple checks, big difference untuk elak setup mistake. Start smart, test on demo dulu, then decide. Tengok full workflow: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  ...
  { title: "Same EA, different account—jangan compare membuta", caption: "Results boleh berbeza ikut balance, settings, broker execution, spread dan market regime. Sebab itu Gemini Bot EA perlu diuji ikut keadaan akaun anda sendiri, bukan copy result orang. Explore dengan lebih bijak: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  ...
  { title: "Bot boleh execute, tapi judgement tetap milik anda", caption: "Gemini Bot EA can follow configured rules on MT5, tetapi anda masih control the setup, monitoring, broker choice and risk. Automation bukan alasan untuk switch off your judgement. Learn more: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  ...
  { title: "Demo first bukan lambat—itu preparation", caption: "Before live funds, verify symbol, permission, lot size and expected behavior on demo. Gemini Bot EA deserves a measured test, bukan keputusan terburu-buru sebab nampak one good screenshot: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #TradingSystem #RiskFirst" },
  { title: "Bukti yang bagus buat kita tanya soalan lebih baik", caption: "Owner-supplied performance evidence boleh bantu anda investigate timing, sizing and conditions. Tapi jangan anggap result itu akan repeat pada account anda. Study the details here: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #DemoFirst #TradingMalaysia" },
  { title: "Jangan lupa trading costs dalam kira-kira", caption: "Spread, slippage, commission, swap and execution boleh affect your result. Kalau nak evaluate Gemini Bot EA, kira semua costs—not just the attractive gross number. Make an informed decision: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  { title: "Automation yang serius perlukan operating plan", caption: "Sebelum guna Gemini Bot EA, decide how you will configure, monitor, pause and review it. Software is one part; your discipline and risk limits are still important. Build your plan: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  ...
  { title: "Banyak trade tak semestinya better result", caption: "Trade frequency alone is not the full story. Tengok size, drawdown, costs, exposure and market conditions sebelum judge Gemini Bot EA. Data should help you investigate, bukan ikut hype: https://ea.fizuxc0der.uk/ #GeminiBotEA #XAUUSD #RiskManagement #MT5" },
  { title: "Ready nak explore Gemini Bot EA?", caption: "Kalau anda serius nak study MT5 automation, start with the risk note, read the workflow and test on demo. Jangan kejar janji—buat review yang boleh anda explain dan monitor. Visit the portal: https://ea.fizuxc0der.uk/ #GeminiBotEA #AlgorithmicTrading #TradingMalaysia #DemoFirst" },
  { title: "Kalau tak boleh explain, jangan terus automate", caption: "Choose only a workflow yang anda faham, boleh monitor and boleh accept risikonya. Gemini Bot EA is an opportunity to evaluate automation, income is never promised. Review the full details before you decide: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #TradingSystem #RiskFirst" },
  ...
  { title: "Last step: decide dengan kepala sendiri", caption: "Dah review the rules, risk note and demo flow? Then decide whether Gemini Bot EA fits your trading plan. No hype, no shortcut—just clear information before you commit: https://ea.fizuxc0der.uk/ #GeminiBotEA #MT5 #RiskManagement #DemoFirst" },
] as const;
