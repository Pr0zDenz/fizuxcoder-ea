...
export function registerTelegramSignalRoute(app: Express) {
  ...
  app.post("/api/telegram/signals/gemini", async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (body.eventType === "tp1_hit" || body.eventType === "tp2_hit" || body.eventType === "tp3_hit" || body.eventType === "sl_hit" || body.eventType === "basket_closed" || body.eventType === "basket_cancelled") {
