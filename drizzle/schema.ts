...
export const paymentOrders = mysqlTable("paymentOrders", {
  ...
  isAdminTrial: mysqlEnum("isAdminTrial", ["yes", "no"]).notNull().default("no"),
...
export const entitlements = mysqlTable("entitlements", {
  ...
  source: mysqlEnum("source", ["paid", "admin_trial", "test"]).notNull().default("paid"),
  trialLabel: varchar("trialLabel", { length: 160 }),
...
export const telegramSignalEvents = mysqlTable("telegramSignalEvents", {
  ...
  fiboTp2: varchar("fiboTp2", { length: 32 }),
  fiboTp3: varchar("fiboTp3", { length: 32 }),
  fiboSlNeg100: varchar("fiboSlNeg100", { length: 32 }),
