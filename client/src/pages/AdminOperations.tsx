  ...
  return (
    <div className="min-h-screen bg-[#17201f] px-5 py-10 text-[#f4f0e8] lg:px-10 lg:py-14">
      <main className="mx-auto max-w-[1120px]">
        ...
        <section className="mt-7 border-b border-white/15 pb-8"><p className="font-mono text-[10px] font-bold uppercase tracking-[.15em] text-[#e5a631]">Restricted administrator operations</p><div className="mt-4 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between"><div><h1 className="font-display text-5xl tracking-[-.06em]">Release and test desk.</h1><p className="mt-4 max-w-2xl text-sm leading-7 text-[#c7d1cb]">These controls are deliberately separated from the customer portal. Every action also requires server-side administrator authorization.</p></div><a href="/admin/marketing" className="button-outline shrink-0 !border-[#e5a631]/70 !text-[#f4f0e8]">Open content studio <ArrowRight size={16} /></a></div></section>
